...
[pp-bogus-misc]
name=pp-bogus-misc
baseurl=http://bogushost.blahblah.com/repo/pp-bogus/misc/\$releasever/\$basearch
gpgcheck=0
enabled=1
priority=1
...
[pp-bogus-jdk]
name=pp-bogus-jdk
baseurl=http://bogushost.blahblah.com/repo/pp-bogus/jdk/\$releasever/\$basearch
gpgcheck=0
enabled=1
priority=1
...
[pp-bogus-ruby]
name=pp-bogus-ruby
baseurl=http://bogushost.blahblah.com/repo/pp-bogus/ruby/\$releasever/\$basearch
gpgcheck=0
enabled=1
priority=1
